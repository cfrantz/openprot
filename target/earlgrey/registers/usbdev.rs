...
#[doc = r" all access to the hardware."]
#[doc = r" "]
#[doc = r" Unlike the non-IntMut instance, this instance allows registers"]
#[doc = r" to be mutated with only a `&self` reference, which is"]
#[doc = r" useful when constructing a driver that needs to be"]
#[doc = r" shared. The driver is responsible for ensuring that shared"]
#[doc = r" access to these registers is done in a compatible way. "]
pub struct UsbdevIntMut {
    _priv: (),
}
impl UsbdevIntMut {
    pub const PTR: *mut u32 = 0x40320000 as *mut u32;
    ...
    #[doc = r" Returns a register block that can be used to read and write"]
    #[doc = r" registers from this peripheral."]
    #[inline(always)]
